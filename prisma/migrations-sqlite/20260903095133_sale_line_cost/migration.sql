...
INSERT INTO "new_SaleLine" ("discount", "discountReason", "gross", "id", "name", "net", "notes", "pricingMode", "productId", "quantity", "requestedAmount", "saleId", "sku", "sortOrder", "stockGrams", "tax", "taxClass", "taxRatePercent", "unitPrice", "weightGrams") SELECT "discount", "discountReason", "gross", "id", "name", "net", "notes", "pricingMode", "productId", "quantity", "requestedAmount", "saleId", "sku", "sortOrder", "stockGrams", "tax", "taxClass", "taxRatePercent", "unitPrice", "weightGrams" FROM "SaleLine";
DROP TABLE "SaleLine";
